...
class AsmResource(Resource):
    ...
    some of them require an HTTP POST with en empty json{},
    therefore a new method fetch() was created.
...
class AsmFixedResource(Resource):
    """Fixed Resource class represents a modifiable ASM object on the device.
    ...
    def fetch(self, **kwargs):
        """Fetch is not supported for ASM Fixed Resources
    ...
    def delete(self, **kwargs):
        """Delete is not supported for ASM Fixed Resources
