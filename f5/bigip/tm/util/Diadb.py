...
REST URI
    ``http://localhost/mgmt/tm/util/diadb``
...
class Diadb(UnnamedResource, CommandExecutionMixin):
    ...
    def __init__(self, util):
        super(Diadb, self).__init__(util)
        self._meta_data['required_command_parameters'].update(('utilCmdArgs',))
        self._meta_data['required_json_kind'] = 'tm:util:diadb:runstate'
