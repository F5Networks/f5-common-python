...
REST URI
    ``http://localhost/mgmt/tm/util/finalize-custom-ami``

GUI Path
    N/A

REST Kind
    ``tm:util:finalize-custom-ami:*``
"""
...
class Finalize_Custom_Ami(UnnamedResource, CommandExecutionMixin):
    ...
    def __init__(self, util):
        super(Finalize_Custom_Ami, self).__init__(util)
        self._meta_data['required_command_parameters'].update(('utilCmdArgs',))
        self._meta_data['required_json_kind'] =\
            'tm:util:finalize-custom-ami:runstate'
