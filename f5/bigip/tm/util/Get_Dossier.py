...
class Get_Dossier(UnnamedResource, CommandExecutionMixin):
    ...
    def __init__(self, util):
        super(Get_Dossier, self).__init__(util)
        self._meta_data['required_command_parameters'].update(('utilCmdArgs',))
        self._meta_data['required_json_kind'] = 'tm:util:get-dossier:runstate'
