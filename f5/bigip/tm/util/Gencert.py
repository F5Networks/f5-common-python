...
REST URI
    ``http://localhost/mgmt/tm/util/gencert``
...
class Gencert(UnnamedResource, CommandExecutionMixin):
    ...
    def __init__(self, util):
        super(Gencert, self).__init__(util)
        self._meta_data['required_command_parameters'].update(('utilCmdArgs',))
        self._meta_data['required_json_kind'] = 'tm:util:gencert:runstate'
