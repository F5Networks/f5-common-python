...
REST URI
    ``http://localhost/mgmt/tm/util/domain-tool``
...
class Domain_Tool(UnnamedResource, CommandExecutionMixin):
    ...
    def __init__(self, util):
        super(Domain_tool, self).__init__(util)
        self._meta_data['required_command_parameters'].update(('utilCmdArgs',))
        self._meta_data['required_json_kind'] = 'tm:util:domain-tool:runstate'
