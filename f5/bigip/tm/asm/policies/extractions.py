...
class Extractions_s(Collection):
    ...
    def __init__(self, policy):
        ...
        self._meta_data['allowed_lazy_attributes'] = [Extraction]
        self._meta_data['required_json_kind'] = 'tm:asm:policies:extractions:extractioncollectionstate'
        self._meta_data['attribute_registry'] = {
            'tm:asm:policies:extractions:extractionstate': Extraction
        }
...
class Extraction(AsmResource):
    ...
    def __init__(self, extractions_s):
        ...
        self._meta_data['required_json_kind'] = 'tm:asm:policies:extractions:extractionstate'
