...
class Tasks(OrganizingCollection):
    ...
    def __init__(self, asm):
        ...
        self._meta_data['asm_object'] = True
...
class Check_Signatures_s(Collection):
    ...
    def __init__(self, tasks):
        ...
        self._meta_data['is_asm_object'] = True
...
class Check_Signature(Resource):
    """BIG-IP® ASM Tasks Check Signature Resource

      This resource is not created in the strict sense, rather it is
      generated by BIGIP upon receipt of a POST with empty JSON body.
    """
    ...
    def create(self):
        """This resource only supports empty JSON posts."""
    ...
    def update(self, **kwargs):
        ''' Update is not supported for Check Signatures
...
class Export_Signature(Resource):
    ...
    def update(self, **kwargs):
        ''' Update is not supported for Export Signatures
...
class Update_Signature(Resource):
    """BIG-IP® ASM Tasks Update Signature Resource


      This resource is not created in the strict sense, it is generated by
      BIGIP upon receipt of a POST with empty JSON body. Considering making
      new method if this is more common.
