...
# Connect to the BigIP and configure the basic attributes
bigip = BigIP('10.190.6.253', 'admin', 'default')
ltm = bigip.ltm
pools = bigip.ltm.pools.get_collection()
pool = bigip.ltm.pools.pool
#members = bigip.ltm.pools.pool.members.get_collection()
#member = bigip.ltm.pools.pool.members_s.member
